...
export function Stats() {
  const stats = [
  {
    ...
    text: '3 kategori SKD utama'
  },
  {
    icon: <Clock className="w-6 h-6 text-gold" />,
    text: '110 menit simulasi penuh'
  },
  {
    icon: <Laptop className="w-6 h-6 text-gold" />,
    text: '24/7 akses latihan mandiri'
  }];

  return (
    <section className="bg-navy-soft py-12 border-b border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 divide-y md:divide-y-0 md:divide-x divide-white/10">
          ...
          <motion.div
            ...
            transition={{
              ...
              <div className="w-12 h-12 rounded-full bg-navy-dark flex items-center justify-center border border-white/5 shrink-0">
                {stat.icon}
              </div>
